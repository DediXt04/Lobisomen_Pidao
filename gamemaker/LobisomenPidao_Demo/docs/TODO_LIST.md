...
- [ ] Remover as 5 fases mockup do `oSeletorDeFases/Create_0.gml`
...
- [ ] Implementar `GUIA_VITORIA_E_SETTINGS.md`
...
## 📅 Pós-entrega (nice-to-have)

- [ ] Tela de Créditos
- [ ] Traduzir nomes/subtítulos das fases (PT/EN)
- [ ] Mascote reativo também em Vitória e Game Over
